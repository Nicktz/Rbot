...
2. Open the app, and then send [botfather](https://core.telegram.org/bots#6-botfather) the message: __/newbot__.
  ...
  - Take note of the Token given by @botfather. It is a looong Token that you can easily misspell. __TIP__: mail this to yourself from your phone and copy Token into R (you will likely type something wrong...).
