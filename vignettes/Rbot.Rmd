...
2. In R, run the following code to save your bot's credentials on your computer (assuming default locations apply):
...
3. Now you can send messages, pdfs and images from R to your phone simply as follows:
...
I hope you enjoy the teamwork from R and your phone from now on. You are welcome to submit any additions to this folder on github.
