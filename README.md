...
connection between Telegram on your phone and their R consoles.
...
error, it will not interrupt your connection to the phone. Rather, it
will show the error message on your phone, and allow you to keep the
connection open. The ability to switch you computer off completely from
your phone is particularly useful when running computers unattended
(e.g. from public terminals).
...
list(Function = Error_Foo,
 ...
 # To just have the ability to shut down R or your computer, set Function_List to NULL (or omit completely):    
 Foo_Bot(Bot_Name = Bot_Name, LoadMessage = "My connection with R", 
         KillR = TRUE, KillCPU = FALSE)
